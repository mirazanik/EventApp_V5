...
class BottomNavBar(c: Context?, attrs: AttributeSet?) : ConstraintLayout(c!!, attrs) {
    ...
    init {
        ...
        setSecondaryTextColor(typedArray.getColor(
                ...
                Color.BLACK))
        setSecondaryImageColor(typedArray.getColor(
        ...
        setStripBackground(typedArray.getColor(
                ...
                Color.WHITE))
        setSecondaryItemTextClickedColor(typedArray.getColor(
                R.styleable.BottomNavBar_secondary_item_text_clicked,
                -1))
        setSecondaryItemImageClickedColor(typedArray.getColor(
    ...
    private fun setUpSecondaryItems(navObjects: List<NavObject>) {
        navObjects.forEach { navObject: NavObject ->
            ...
            navItem.setItem(navObject.name, navObject.image, properties.secondaryTextColor, properties.secondaryImageColor)
