...
public class DatePickerDialog extends DialogFragment implements
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (mAccentColor != -1) {
            ...
            //okButton.setTextColor(mAccentColor); //hide code because dark mode app button color automatically set to black
            //cancelButton.setTextColor(mAccentColor);//hide code because dark mode app button color automatically set to black
